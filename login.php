        ...
        <div class="wrapper fadeInDown align-item-center">
            <div id="formContent">
                ...
                <div class="fadeIn first mt-4">
                    ...
                    <h5 class="text-primary-emphasis">SILAT</h5>
                    <p class="text-primary-emphasis">Sistem Informasi Layanan Teknik</p>
                </div>

                <!-- Login Form -->
                <form id="login" method="post">
                    <input type="text" id="nim" class="fadeIn second" name="nim" placeholder="NIM" />
                    <input type="password" id="password" class="fadeIn third" name="pass" placeholder="Kata Sandi" />
            ...
            success: function(response) {
                ...
                if (res.status == 200) { //status sukses
                    Swal.fire({
                        ...
                        top.location.href = 'index.php'; // redirect ke halaman index.php
                    });
