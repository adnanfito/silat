...
if(isset( $_FILES['berkas'] )) {
    ...
    $path = '../document/berkas_jadi/surat-ket-mhs/'; // upload directory
    $path_to_db = 'document/berkas_jadi/surat-ket-mhs/';
    $id = $_POST['id'];
    ...
    { 
        ...
        if(move_uploaded_file($tmp,$path)) 
        {
            ...
            try{
                mysqli_query($con,"UPDATE surat_ket_mhs SET surat_jadi = '".$path_to_db."', status = 'setuju' WHERE id = $id");
