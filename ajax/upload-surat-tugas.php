...
if(isset( $_FILES['berkas'] )) {
    ...
    $path = '../document/berkas_jadi/surat-tugas-kp/'; // upload directory
    $path_to_db = 'document/berkas_jadi/surat-tugas-kp/';
    $id = $_POST['id'];
    ...
    { 
        ...
        if(move_uploaded_file($tmp,$path)) 
        {
            ...
            try{
                mysqli_query($con,"UPDATE surat_tugas SET surat_jadi = '".$path_to_db."', status = 'setuju' WHERE id = $id");
