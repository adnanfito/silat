...
if(isset($_POST['id'])){
    ...
    $query = "SELECT * FROM surat_izin_kp where id = $id";
    // Menjalankan Query
            ...
            <div class="col-10 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Detail Pengajuan Surat Izin KP</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body table-responsive p-0" style="height: 65vh">
                        <table class="table table-hover">
                            <tbody>
                                ...
                                <tr>
                                    <td class="col-md-3">IPK</td>
                                    <td>:</td>
                                    <td><?= $row['ipk']; ?></td>
                                </tr>
                                <tr>
                                    <td class="col-md-3">SKSK</td>
                                    <td>:</td>
                                    <td><?= $row['sksk']; ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="col-md-3">Keperluan</td>
                                    <td>:</td>
                                    <td><?= $row['keperluan']; ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="col-md-3">Instansi yang dituju</td>
                                    <td>:</td>
                                    <td><?= $row['instansi']; ?></td>
                                </tr>
                                <tr>
                                    <td class="col-md-3">Alamat Instansi</td>
                                    <td>:</td>
                                ...
                                <tr class="col-md-3">
                                    <td>Surat Permohonan dari Prodi</td>
                                    <td>:</td>
                                    <td><a href="<?= $row['surat_permohonan']; ?>" class="btn btn-primary"
                                            download="Surat Permohonan Prodi_<?= $row['nama_mhs']; ?>">Unduh
                                            File</a>
                                    </td>
                                </tr>
                                <tr class="col-md-3">
                                    <td>KRS</td>
                                    <td>:</td>
                                    <td><a href="<?= $row['krs']; ?>" class="btn btn-primary"
                                            download="KRS_<?= $row['nama_mhs']; ?>">Unduh
                                            File</a>
                                    </td>
                                </tr>
...
function setuju(id) {
    (async () => {
        ...
        if (file) {
            ...
            $.ajax({
                method: 'post',
                url: 'ajax/upload-surat-izin.php',
                data: formData,
                processData: false,
                contentType: false,
